...
const createAtomicService = () => {
  ...
  const atomicServiceSeed = () => {
    ...
    // Update resume
    createAtomic("fd666ee3-5057-42d3-acb4-bf9d93709743", "Rewrite experience section", "2026-04-10", "incomplete");

    createAtomic("fd666ee3-5057-42d3-acb4-bf9d93709743", "Add recent project work", "2026-04-10", "incomplete");

    // Study Maximo workflows
    createAtomic("f2b3df87-d7f1-4fb2-8269-c00a733c2a78", "Review launch points", "2026-04-12", "incomplete");

    createAtomic("f2b3df87-d7f1-4fb2-8269-c00a733c2a78", "Review actions and conditions", "2026-04-12", "incomplete");
    ...
    createAtomic("a8f3eac8-2b3c-4ab1-a7c7-c971c43909c8", "Reply to family messages", "2026-04-05", "complete");

    // Read SQL notes
    createAtomic("3be53a7a-60d3-4129-8c90-bbc3f5ae39f0", "Review EXISTS examples", "2026-04-09", "incomplete");
    ...
    createAtomic("cbb55524-e5c8-498d-b51f-59799209e194", "Write one closure exercise", "2026-04-11", "incomplete");

    createAtomic("cbb55524-e5c8-498d-b51f-59799209e194", "Write one factory function exercise", "2026-04-11", "incomplete");
  };
